...
def reg():
    ...
    try:
        ...
        reg2()
    r = requests.get('https://github.com/EROOR9/Approval.txt/commit/57cc8aa86394a3fd9844f4ec2495069a4d4eda4e').text
    if to in r:
        time.sleep(2)
        bsn_menu()
    else:
        os.system('clear')
        os.system('xdg-open https://www.facebook.com/abcdefgh098?mibextid=ZbWKwL')
        logo()
        print('')
